  ...
  const projects: Project[] = [
    {
      ...
      description: "A comprehensive job application tracking system built with React and Node.js. Features include application status management, interview scheduling, and analytics dashboard.",
    ...
    },
    {
      ...
      description: "A modern weather application providing real-time weather data with beautiful UI and location-based forecasts.",
    ...
    },
    {
      ...
      description: "A practical shopping list application with item management, categories, and offline functionality.",
    ...
    },
    {
      ...
      description: "An interactive dictionary application with word definitions, pronunciations, and favorites functionality using Redux for state management.",
    ...
    },
    {
      ...
      description: "A comprehensive safety data sheet management system for electrical safety compliance, featuring document management and safety tracking.",
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <p style={{ 
            ...
            Explore my portfolio of web applications and mobile solutions. Each project represents a unique challenge solved with modern technologies.
          </p>
        </div>
        ...
        <div style={{ 
          ...
          {categories.map((category) => (
            <button
              ...
              style={{
                padding: '12px 24px',
                backgroundColor: activeFilter === category.id ? 'white' : 'transparent',
                ...
                boxShadow: activeFilter === category.id ? '0 5px 15px rgba(255,255,255,0.3)' : 'none'
              }}
              onMouseEnter={(e) => {
              ...
              <div style={{ 
                ...
                <button
                  ...
                  style={{
                    flex: 1,
                    padding: '12px',
                    backgroundColor: project.liveUrl === "#" ? '#333333' : 'white',
        ...
        <div style={{ textAlign: 'center', marginTop: '60px' }}>
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 10px 20px rgba(255,255,255,0.3)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.backgroundColor = 'transparent';
              e.currentTarget.style.color = 'white';
